 ...
 */
public class TestDataConnector extends AbstractDataConnector {

    /** Log4j logger. */
    @NonnullAfterInit private final Logger log =  LoggerFactory.getLogger(TestDataConnector.class);
...
//    private Map<String, BaseAttribute> attributes;
    ...
    private String getPrincipal (
        ...
        final Map<String,List<IdPAttributeValue>> dependencyAttributes =
                PluginDependencySupport.getAllAttributeValues(workContext, getAttributeDependencies(), getDataConnectorDependencies() );
	   ...
	   String strNextLine = "";
           ...
           while ( (strNextLine = in.readLine()) != null ) {
             ...
             if (tokens.length != 2) {
               ...
               List<IdPAttributeValue> outputValue = Lists.newArrayListWithExpectedSize(1);
